import type { AuthResolvedSession } from '@/modules/auth/domain/types/auth-profile.types'
...
import { compileStreamSource } from '@/modules/source/services/compilers/stream-source-compile'
