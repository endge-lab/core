import type { EndgeStyleMatchNode } from '@/modules/styles/domain/types/style.types'

import { describe, expect, it } from 'vitest'
import { compileEndgeCSS } from '@/modules/styles/services/endgecss-compile'
import { matchEndgeStyleSelector, resolveEndgeStyleDeclarations } from '@/modules/styles/services/endgecss-match'
