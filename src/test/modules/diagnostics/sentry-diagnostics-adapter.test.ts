...
import type { DiagnosticsAdapterCreateContext } from '@/modules/diagnostics/domain/types/diagnostics-adapter.type'
import type {
...
import { SentryDiagnosticsAdapter } from '@/modules/diagnostics/adapters/SentryDiagnosticsAdapter'
