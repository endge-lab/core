...
import type { DestroyedRuntimeHostSnapshot, RuntimeHost } from '@/features/core/modules/runtime/domain/runtime-host.types'
import type {
  RuntimeHostRegistryLike,
  RuntimeHostRegistrySnapshot,
} from '@/features/core/modules/runtime/domain/runtime-registry.types'
