import type { ComponentSFCEventInputValue } from '@/features/core/modules/domain/types/component/sfc/ports.types'
import type { ProgramDiagnostic } from '@/features/core/modules/program/domain/types/program.types'
import type { VocabLoadPolicy } from '@/features/core/modules/runtime/domain/vocab-cache.types'
import type {
...
import type { UpdateMutationStrategy } from '@/features/core/modules/source/domain/types/update-source.types'
...
function mapExpression(
  ...
  ) => import('@/features/core/modules/source/domain/types/source-expression.types').SourceExpressionIR,
): import('@/features/core/modules/source/domain/types/source-expression.types').SourceExpressionIR {
...
function collectExpressionReads(expression: import('@/features/core/modules/source/domain/types/source-expression.types').SourceExpressionIR): Array<Extract<import('@/features/core/modules/source/domain/types/source-expression.types').SourceExpressionIR, { type: 'read' }>> {
  if (expression.type === 'read') {
    return [expression]
  }
  if (expression.type === 'operation') {
