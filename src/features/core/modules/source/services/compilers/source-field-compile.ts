...
import type {
  ...
  SourceFieldOption,
  SourceFieldType,
} from '@/features/core/modules/source/domain/types/source-expression.types'
...
function isStaticExpression(expression: import('@/features/core/modules/source/domain/types/source-expression.types').SourceExpressionIR): boolean {
...
function staticExpressionValue(expression: import('@/features/core/modules/source/domain/types/source-expression.types').SourceExpressionIR): unknown {
  if (expression.type === 'literal') {
