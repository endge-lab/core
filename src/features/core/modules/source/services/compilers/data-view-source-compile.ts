import type { DataViewProgramPayload, ProgramDiagnostic } from '@/features/core/modules/program/domain/types/program.types'
import type {
  DataViewExpression,
...
import { readSourceModelIdentity, readSourceModelReference } from '@/features/core/modules/source/services/compilers/source-model-reference-compile'
...
function readDataViewProps(
  ...
  source: string,
  diagnostics: DiagnosticDraft[],
): import('@/features/core/modules/source/domain/types/source-expression.types').SourceFieldDefinition[] {
  ...
  const props: import('@/features/core/modules/source/domain/types/source-expression.types').SourceFieldDefinition[] = []
