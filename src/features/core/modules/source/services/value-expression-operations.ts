import type { SourceExpressionIR, SourceExpressionOperation, SourceExpressionWarning } from '@/features/core/modules/source/domain/types/source-expression.types'
