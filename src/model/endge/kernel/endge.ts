...
export class Endge extends EndgeFederation {
  ...
  /** Преобразует Payload/domain документы в переносимые записи нового backend без локального состояния. */
  ...
  /** Строит соответствие Payload id -> стабильная identity для portable relations. */
  ...
  /** Разрешает relation object, Payload id или готовую identity в стабильную identity. */
