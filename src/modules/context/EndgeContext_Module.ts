...
import type {
  ...
  EndgeStorageAdapter,
} from '@/modules/context/domain/context-persistence.types'
import type { EndgePersistenceInput } from '@/modules/context/persistence/EndgeStorageAdapterRegistry'
import type {
  EndgeExecutionContext,
  EndgeExecutionContextResolutionInput,
} from '@/modules/runtime/domain/execution-context.types'
...
} from '@/kernel/config/kernel.config'
import { Endge } from '@/kernel/endge'
import { EndgeModule } from '@/kernel/EndgeModule'
import { createEndgePublicConfigurationSnapshot } from '@/modules/configuration/domain/endge-configuration'
import { DisabledContextAdapter } from '@/modules/context/persistence/adapters/DisabledContextAdapter'
...
} from '@/modules/context/persistence/EndgeStorageAdapterRegistry'
import { RuntimeStateController } from '@/modules/context/persistence/RuntimeStateController'
