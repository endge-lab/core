...
import type { ImplementationInvocation, ImplementationProvider } from '@/modules/runtime/domain/implementation.types'
...
import { normalizeActionTargets, validateActionTarget } from '@/modules/compiler/services/action/action-target-validation'
import { RAction } from '@/modules/domain/entities/RAction'
import { RField } from '@/modules/domain/entities/RField'
import { BUILTIN_ACTION_IDS } from '@/modules/runtime/domain/action.types'
