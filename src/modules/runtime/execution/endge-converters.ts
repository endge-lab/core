import type { EntityOrigin } from '@/modules/domain/types/document/entity-management.type'
import type { ImplementationBindingScope } from '@/modules/runtime/domain/action.types'
import type { ImplementationProvider } from '@/modules/runtime/domain/implementation.types'
import type { EndgeImplementations } from '@/modules/runtime/implementation/endge-implementations'
import { Endge } from '@/kernel/endge'
import { split } from '@/modules/runtime/converters/arrays/split'
import { toArray } from '@/modules/runtime/converters/arrays/to-array'
import { dateToDateString } from '@/modules/runtime/converters/date/date-to-date-string'
import { dateToIsoString } from '@/modules/runtime/converters/date/date-to-iso-string'
import { dateToIsoZ } from '@/modules/runtime/converters/date/date-to-iso-z'
import { dateToTimeString } from '@/modules/runtime/converters/date/date-to-time-string'
import { isoStringToDate } from '@/modules/runtime/converters/date/iso-string-to-date'
import { isoStringToTimeString } from '@/modules/runtime/converters/date/iso-string-to-time-string'
import { stringToDate } from '@/modules/runtime/converters/date/string-to-date'
import { timeStringToDate } from '@/modules/runtime/converters/date/time-string-to-date'
import { timestampToDate } from '@/modules/runtime/converters/date/timestamp-to-date'
import { weekdaysRange } from '@/modules/runtime/converters/date/weekdays-range'
import { jsonParse } from '@/modules/runtime/converters/json/json-parse'
import { jsonStringify } from '@/modules/runtime/converters/json/json-stringify'
import { numberToString } from '@/modules/runtime/converters/numbers/number-to-string'
import { stringToNumber } from '@/modules/runtime/converters/numbers/string-to-number'
import { defaultIfEmpty } from '@/modules/runtime/converters/strings/default-if-empty'
import { stringToBoolean } from '@/modules/runtime/converters/strings/string-to-boolean'
import { stringTrim } from '@/modules/runtime/converters/strings/string-trim'
