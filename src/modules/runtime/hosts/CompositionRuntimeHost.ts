...
import type { RuntimeArtifactReader, RuntimeHost, RuntimeHostContext, RuntimeHostInputBinding, RuntimeHostInputSource, RuntimeHostUpdateContext } from '@/modules/runtime/domain/runtime-host.types'
import type { VocabRuntimeCatalog } from '@/modules/runtime/domain/vocab-cache.types'
import type { ComponentSFCRuntimeHost } from '@/modules/runtime/hosts/ComponentSFCRuntimeHost'
import type { FilterRuntimeHost } from '@/modules/runtime/hosts/FilterRuntimeHost'
import type { FilterViewRuntimeHost } from '@/modules/runtime/hosts/FilterViewRuntimeHost'
...
import type { StreamRuntimeHost } from '@/modules/runtime/hosts/StreamRuntimeHost'
import type { OperationHistoryShortcutBinding } from '@/modules/runtime/operation/operation-history'
import type {
...
} from '@/modules/source/domain/types/composition-source.types'

import type { StreamEventEnvelope } from '@/modules/source/domain/types/stream-source.types'

import type { StoreMutationPlan } from '@/modules/source/domain/types/update-source.types'
import { collectionByKey, filterByKey, full, Raph, RaphNode } from '@endge/raph'
import { Endge } from '@/kernel/endge'
import { normalizeComponentSFCInteractionTriggers } from '@/modules/domain/component/component-sfc-edit-trigger'
import { buildCompositionI18nCatalogs, cloneI18nRuntimeCatalog } from '@/modules/i18n/services/i18n-catalog'
import { FilterViewRuntimeHost as EndgeFilterViewRuntimeHost } from '@/modules/runtime/hosts/FilterViewRuntimeHost'
...
export class CompositionRuntimeHost extends RuntimeHostBase<'composition', RuntimeHostContext<'composition'>, CompositionProgramPayload> {
  ...
  private _readExpressionSource(
    read: Extract<import('@/modules/source/domain/types/source-expression.types').SourceExpressionIR, { type: 'read' }>,
  ): unknown {
  ...
  private _collectExpressionReads(
    expression: import('@/modules/source/domain/types/source-expression.types').SourceExpressionIR,
  ): Array<Extract<import('@/modules/source/domain/types/source-expression.types').SourceExpressionIR, { type: 'read' }>> {
