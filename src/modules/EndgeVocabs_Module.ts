import type { ProgramArtifact, QueryProgramOutput } from '@/modules/program/domain/types/program.types'
...
import type { VocabMockReference, VocabPayloadProvider, VocabProgramPayload } from '@/modules/source/domain/types/vocab-source.types'
