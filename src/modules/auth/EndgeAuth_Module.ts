...
import type { AuthInteractionRequiredError } from '@/modules/auth/domain/AuthInteractionRequiredError'
import type { AuthProfileSchema, OidcBrowserSessionOptions } from '@/modules/auth/domain/types/auth-profile.types'

import type { DiagnosticsAttributes } from '@/modules/diagnostics/domain/types/diagnostics.types'
...
import { OidcBrowserSession_Adapter } from '@/modules/auth/adapters/OidcBrowserSession_Adapter'
