...
import type { DiagnosticsAdapterRegistry } from '@/modules/diagnostics/adapters/DiagnosticsAdapterRegistry'
import type {
  DiagnosticsAdapter,
...
} from '@/modules/diagnostics/config/diagnostics.config'
import { DiagnosticsRecordStore } from '@/modules/diagnostics/domain/entities/DiagnosticsRecordStore'
import { DiagnosticsSpan } from '@/modules/diagnostics/domain/entities/DiagnosticsSpan'
...
export class EndgeTelemetry_Module extends EndgeModule implements DiagnosticsSpanOwner {
  ...
  public registerAdapter(adapter: DiagnosticsAdapter): () => void {
    ...
    this._scheduleNotify()
    return () => {
      void this.unregisterAdapter(id)
    }
  }
