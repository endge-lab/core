...
} from '@/modules/diagnostics/domain/types/diagnostics-adapter.type'
import type {
...
import { CONSOLE_DIAGNOSTICS_ADAPTER_FACTORY } from '@/modules/diagnostics/adapters/ConsoleDiagnosticsAdapter'
import { DiagnosticsAdapterRegistry } from '@/modules/diagnostics/adapters/DiagnosticsAdapterRegistry'
import { SENTRY_DIAGNOSTICS_ADAPTER_FACTORY } from '@/modules/diagnostics/adapters/SentryDiagnosticsAdapter'
import { EndgeProblems_Module } from '@/modules/diagnostics/EndgeProblems_Module'
import { EndgeTelemetry_Module } from '@/modules/diagnostics/EndgeTelemetry_Module'
