...
import type { EntityRef } from '@/modules/domain/types/document/entity-management.type'

import type { ActionImplementation, ActionTargetSelector } from '@/modules/runtime/domain/action.types'
