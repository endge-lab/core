...
import type { FilterFieldItemSchema, RFilterSchema } from '@/modules/domain/types/document/filter.types'

import { Expose } from 'class-transformer'

import { REntity } from '@/modules/domain/entities/REntity'
import { FilterType } from '@/modules/domain/types/document/document.types'
