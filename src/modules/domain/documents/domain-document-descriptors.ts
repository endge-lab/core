import type { DocumentSerializationContext } from '@/modules/domain/documents/service-document-serializer'
import type { RComponent } from '@/modules/domain/types/component/component.types'
import type { DocumentDraftOptions } from '@/modules/domain/types/document/document-draft.type'
import type { DomainDocumentType } from '@/modules/domain/types/document/document.types'
import type { EndgeDomainCollection } from '@/modules/domain/types/document/domain-provider.type'
import type { ProgramEntityType } from '@/modules/program/domain/types/program.types'
import type { RuntimeEntityType } from '@/modules/runtime/domain/runtime-entity-map.types'
import type { SourceKind } from '@/modules/source/domain/types/source-engine.types'
...
import { ReflectComponentFromPlain } from '@/modules/domain/entities/RComponent'
...
import { RConfiguration } from '@/modules/domain/entities/RConfiguration'
import { RConverter } from '@/modules/domain/entities/RConverter'
import { RDataView } from '@/modules/domain/entities/RDataView'
import { REnvironment } from '@/modules/domain/entities/REnvironment'
import { RFilter } from '@/modules/domain/entities/RFilter'
import { RI18nBundle } from '@/modules/domain/entities/RI18nBundle'
import { RIntegration } from '@/modules/domain/entities/RIntegration'
import { RMock } from '@/modules/domain/entities/RMock'
import { RNavigation } from '@/modules/domain/entities/RNavigation'
import { RPage } from '@/modules/domain/entities/RPage'
import { RPageTemplate } from '@/modules/domain/entities/RPageTemplate'
import { RParameter } from '@/modules/domain/entities/RParameter'
import { RPolicy } from '@/modules/domain/entities/RPolicy'
...
import { RStream } from '@/modules/domain/entities/RStream'
...
import { RUpdate } from '@/modules/domain/entities/RUpdate'
import { RVocabs } from '@/modules/domain/entities/RVocabs'
import { RWorkspace } from '@/modules/domain/entities/RWorkspace'
import { ComponentType, DOMAIN_DOCUMENT_TYPES, DomainSectionType, FilterType, ParameterType, QueryType } from '@/modules/domain/types/document/document.types'
import { ACTION_DEFAULT_SOURCE } from '@/modules/source/templates/action.default.source'
import { COMPONENT_SFC_DEFAULT_SOURCE } from '@/modules/source/templates/component-sfc/component-sfc.default.source'
import { COMPOSITION_DEFAULT_SOURCE } from '@/modules/source/templates/composition.default.source'
import { COMPUTATION_DEFAULT_SOURCE } from '@/modules/source/templates/computation.default.source'
import { DATA_VIEW_DEFAULT_SOURCE } from '@/modules/source/templates/data-view.default.source'
import { FILTER_DEFAULT_SOURCE } from '@/modules/source/templates/filter.default.source'
import { QUERY_DEFAULT_SOURCE, QUERY_GRAPHQL_DEFAULT_SOURCE } from '@/modules/source/templates/query.default.source'
import { STORE_DEFAULT_SOURCE } from '@/modules/source/templates/store.default.source'
import { STREAM_DEFAULT_SOURCE } from '@/modules/source/templates/stream.default.source'
import { TYPE_DEFAULT_SOURCE } from '@/modules/source/templates/type.default.source'
