import type {
  ...
  I18nLocales,
  I18nRuntimeCatalog,
} from '@/modules/i18n/domain/i18n.types'
import type { CompositionI18nResourceArtifact, CompositionProgramPayload } from '@/modules/source/domain/types/composition-source.types'
