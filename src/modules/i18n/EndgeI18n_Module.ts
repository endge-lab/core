...
import type { I18nLocaleMessages, I18nMessagesOptions, I18nRuntimeCatalog, I18nTranslateOptions } from '@/modules/i18n/domain/i18n.types'

import { DEFAULT_FALLBACK_LOCALE } from '@/kernel/config/kernel.config'
