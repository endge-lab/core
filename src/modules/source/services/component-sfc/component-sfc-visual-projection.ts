...
import { readComponentSFCTableMenuActionPortReference } from '@/modules/compiler/services/component-sfc/component-sfc-table-menu'
...
import { BUILTIN_ACTION_IDS, TABLE_RUNTIME_ACTION_IDS } from '@/modules/runtime/domain/action.types'
