...
import type {
  ...
  SourceFieldOption,
  SourceFieldType,
} from '@/modules/source/domain/types/source-expression.types'
...
import { compileProgramMetadataExpression } from '@/modules/source/services/compilers/source-metadata-compile'
...
function isStaticExpression(expression: import('@/modules/source/domain/types/source-expression.types').SourceExpressionIR): boolean {
...
function staticExpressionValue(expression: import('@/modules/source/domain/types/source-expression.types').SourceExpressionIR): unknown {
  if (expression.type === 'literal') {
