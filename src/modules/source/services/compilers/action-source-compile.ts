...
import type { ProgramDependency, ProgramDiagnostic } from '@/modules/program/domain/types/program.types'
...
} from '@/modules/source/domain/types/action-source.types'
import type { SourceExpressionIR } from '@/modules/source/domain/types/source-expression.types'
import { parse } from '@babel/parser'
import * as t from '@babel/types'
import { functionSource, validateSandboxBody } from '@/modules/compiler/services/computation/computation-compile'
import {
