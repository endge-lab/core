import type { DataViewProgramPayload, ProgramDiagnostic } from '@/modules/program/domain/types/program.types'
import type {
  DataViewExpression,
  ...
  DataViewSourceMode,
} from '@/modules/source/domain/types/data-view-source.types'
...
import { readSourceModelIdentity, readSourceModelReference } from '@/modules/source/services/compilers/source-model-reference-compile'
...
function readDataViewProps(
  ...
  source: string,
  diagnostics: DiagnosticDraft[],
): import('@/modules/source/domain/types/source-expression.types').SourceFieldDefinition[] {
  ...
  const props: import('@/modules/source/domain/types/source-expression.types').SourceFieldDefinition[] = []
