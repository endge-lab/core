...
} from '@/modules/source/domain/types/query-source.types'
import type { ResponseOutputTransform } from '@/modules/source/domain/types/response-output.types'
import type { QueryProgramProp, SourceExpressionIR } from '@/modules/source/domain/types/source-expression.types'

import { parse as parseTS } from '@babel/parser'
import * as t from '@babel/types'
import { Kind, parse as parseGraphQL } from 'graphql'

import { QueryType } from '@/modules/domain/types/document/document.types'
import { compileSourceCallback, compileSourceExpression } from '@/modules/source/services/compilers/source-expression-compile'
...
import { readSourceModelReference } from '@/modules/source/services/compilers/source-model-reference-compile'
...
function containsOnlyReads(
  ...
  allowed: Set<import('@/modules/source/domain/types/source-expression.types').SourceExpressionReadKind>,
): boolean {
