...
} from '@/modules/source/domain/types/filter-view.type'
...
import { DEFAULT_VOCAB_LOAD_POLICY } from '@/modules/runtime/domain/vocab-cache.types'
import {
  ...
  readStringArgument,
  unwrapExpression,
} from '@/modules/source/services/compilers/source-expression-compile'
import { compileSourceField } from '@/modules/source/services/compilers/source-field-compile'
import { compileProgramMetadataProperty } from '@/modules/source/services/compilers/source-metadata-compile'
...
function mapExpression(
  ...
  ) => import('@/modules/source/domain/types/source-expression.types').SourceExpressionIR,
): import('@/modules/source/domain/types/source-expression.types').SourceExpressionIR {
...
function collectExpressionReads(expression: import('@/modules/source/domain/types/source-expression.types').SourceExpressionIR): Array<Extract<import('@/modules/source/domain/types/source-expression.types').SourceExpressionIR, { type: 'read' }>> {
  if (expression.type === 'read') {
    return [expression]
  }
  if (expression.type === 'operation') {
