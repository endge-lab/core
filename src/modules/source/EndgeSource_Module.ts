...
import { SourceEngineRegistry } from '@/modules/source/services/SourceEngineRegistry'
import { SourceLanguageRegistry } from '@/modules/source/services/SourceLanguageRegistry'
import { SourcePatchRegistry } from '@/modules/source/services/SourcePatchRegistry'
import { ActionSourceEngineStrategy } from '@/modules/source/services/strategies/ActionSourceEngineStrategy'
import { ActionSourceLanguageStrategy } from '@/modules/source/services/strategies/ActionSourceLanguageStrategy'
import { CompositionSourceEngineStrategy } from '@/modules/source/services/strategies/CompositionSourceEngineStrategy'
import { CompositionSourceLanguageStrategy } from '@/modules/source/services/strategies/CompositionSourceLanguageStrategy'
import { CompositionSourcePatchStrategy } from '@/modules/source/services/strategies/CompositionSourcePatchStrategy'
import { ComputationSourceEngineStrategy } from '@/modules/source/services/strategies/ComputationSourceEngineStrategy'
import { ComputationSourceLanguageStrategy } from '@/modules/source/services/strategies/ComputationSourceLanguageStrategy'
import { ConfigurationSourceEngineStrategy } from '@/modules/source/services/strategies/ConfigurationSourceEngineStrategy'
import { ConfigurationSourceLanguageStrategy } from '@/modules/source/services/strategies/ConfigurationSourceLanguageStrategy'
import { DataViewSourceEngineStrategy } from '@/modules/source/services/strategies/DataViewSourceEngineStrategy'
import { DataViewSourceLanguageStrategy } from '@/modules/source/services/strategies/DataViewSourceLanguageStrategy'
import { FilterSourceEngineStrategy } from '@/modules/source/services/strategies/FilterSourceEngineStrategy'
import { FilterSourceLanguageStrategy } from '@/modules/source/services/strategies/FilterSourceLanguageStrategy'
import { FilterSourcePatchStrategy } from '@/modules/source/services/strategies/FilterSourcePatchStrategy'
import { QuerySourceEngineStrategy } from '@/modules/source/services/strategies/QuerySourceEngineStrategy'
import { QuerySourceLanguageStrategy } from '@/modules/source/services/strategies/QuerySourceLanguageStrategy'
import { QuerySourcePatchStrategy } from '@/modules/source/services/strategies/QuerySourcePatchStrategy'
import { StoreSourceEngineStrategy } from '@/modules/source/services/strategies/StoreSourceEngineStrategy'
import { StoreSourceLanguageStrategy } from '@/modules/source/services/strategies/StoreSourceLanguageStrategy'
import { StreamSourceEngineStrategy } from '@/modules/source/services/strategies/StreamSourceEngineStrategy'
import { StreamSourceLanguageStrategy } from '@/modules/source/services/strategies/StreamSourceLanguageStrategy'
import { StyleSourceEngineStrategy } from '@/modules/source/services/strategies/StyleSourceEngineStrategy'
import { StyleSourceLanguageStrategy } from '@/modules/source/services/strategies/StyleSourceLanguageStrategy'
import { TypeSourceEngineStrategy } from '@/modules/source/services/strategies/TypeSourceEngineStrategy'
import { TypeSourceLanguageStrategy } from '@/modules/source/services/strategies/TypeSourceLanguageStrategy'
import { UpdateSourceEngineStrategy } from '@/modules/source/services/strategies/UpdateSourceEngineStrategy'
import { UpdateSourceLanguageStrategy } from '@/modules/source/services/strategies/UpdateSourceLanguageStrategy'
import { VocabSourceEngineStrategy } from '@/modules/source/services/strategies/VocabSourceEngineStrategy'
import { VocabSourceLanguageStrategy } from '@/modules/source/services/strategies/VocabSourceLanguageStrategy'
import { VocabSourcePatchStrategy } from '@/modules/source/services/strategies/VocabSourcePatchStrategy'
...
export class EndgeSource_Module extends EndgeModule {
  ...
  private _registerDefaultStrategies(): void {
    ...
    this._languageStrategies.register(new ConfigurationSourceLanguageStrategy())
