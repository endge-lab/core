...
import type { RComponentSFC_SourceRange } from '@/modules/domain/types/component/sfc/location.types'
...
import { parseSFCSourceParts } from '@/modules/domain/component/sfc/component-sfc-source-parts'
