...
import type { RComponentSFC_AST_Style } from '@/modules/domain/types/component/sfc/ast.types'
import type { RComponentSFC_IR_Style } from '@/modules/domain/types/component/sfc/ir.types'
