...
import type { ProgramNodeMetadata } from '@/modules/program/domain/types/program-metadata.types'
import { parseExpression } from '@babel/parser'
import { isComponentSFCBuiltInTag } from '@/modules/compiler/services/component-sfc/component-sfc-built-in-tags'
import { compileComponentSFCExpression } from '@/modules/compiler/services/component-sfc/component-sfc-expression'
import { createBuiltInComponentPortManifest } from '@/modules/compiler/services/component-sfc/component-sfc-forward'
import {
  compileComponentSFCInteractionAnnotation,
  hasComponentSFCPassivePreventConflict,
} from '@/modules/compiler/services/component-sfc/component-sfc-interactions'
import { compileComponentSFCLocalEventActions } from '@/modules/compiler/services/component-sfc/component-sfc-ports'
...
import { DEFAULT_ENDGE_SFC_EDITING_CONFIGURATION } from '@/modules/domain/component/sfc-editing.config'
import { createEmptyComponentDependencies } from '@/modules/domain/types/component/component-core.types'
import { createEmptyComponentSFCPortManifest } from '@/modules/domain/types/component/sfc/ports.types'
import { compileProgramMetadataSource } from '@/modules/source/services/compilers/source-metadata-compile'
...
export { isComponentSFCBuiltInTag } from '@/modules/compiler/services/component-sfc/component-sfc-built-in-tags'
