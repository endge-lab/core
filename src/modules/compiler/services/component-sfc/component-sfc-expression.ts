import type { EndgeRuntimeContextSnapshot } from '@/modules/context/domain/context-persistence.types'
...
import type { EndgeConfigurationSchemaEntry } from '@/modules/source/domain/types/configuration-source.types'
