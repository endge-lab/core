...
import type { ComponentSFCCompileResult } from '@/modules/compiler/services/component-sfc/component-sfc-compile'
import type { EndgeSFCEditingConfiguration } from '@/modules/configuration/domain/types/configuration.type'
import type { DiagnosticsSpanHandle } from '@/modules/diagnostics/domain/types/diagnostics.types'
...
import type { CompositionBindingValue, CompositionProgramPayload } from '@/modules/source/domain/types/composition-source.types'

import type { DataViewMaterializationStrategy, DataViewPipelineStep, DataViewRef } from '@/modules/source/domain/types/data-view-source.types'
import type { FilterProgramPayload } from '@/modules/source/domain/types/filter-source.types'
...
import type { TypeProgramCatalogEntry, TypeProgramPayload, TypeSourceDefinition, TypeSourceExpression } from '@/modules/source/domain/types/type-source.types'
import type { UpdateSourceArtifact } from '@/modules/source/domain/types/update-source.types'
import type { VocabProgramPayload } from '@/modules/source/domain/types/vocab-source.types'
import type { EndgeStyleSheetArtifact } from '@/modules/styles/domain/types/style.types'
import { ENDGE_COMPILER_SPAN_GROUPS, ENDGE_COMPILER_VERSION } from '@/kernel/config/kernel.config'
import { Endge } from '@/kernel/endge'
import { EndgeModule } from '@/kernel/EndgeModule'
import { compileAction } from '@/modules/compiler/services/action/action-compile'
...
} from '@/modules/compiler/services/type/type-program-validation'
...
} from '@/modules/domain/types/component/sfc/intrinsic-events.types'
import { TABLE_EVENT_DEFINITIONS } from '@/modules/domain/types/component/sfc/table-events.types'
import { collectI18nMessageKeys, compileI18nLocales } from '@/modules/i18n/services/i18n-catalog'
